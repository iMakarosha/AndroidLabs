...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        originalDrawable = findViewById(R.id.etCountry).getBackground();
        ...
        AutoCompleteTextView actwCountry = findViewById(R.id.etCountry);
        ...
        AutoCompleteTextView actwCity = findViewById(R.id.etCity);
        ...
        findViewById(R.id.etCountry).setOnFocusChangeListener((v, hasFocus) -> {
            if (!hasFocus) {
                etCityAdapter.clear();
        ...
        findViewById(R.id.etEmail).setOnFocusChangeListener((v, hasFocus) -> {
            if (!hasFocus) {
    ...
    public void checkBaseForm(View view) {
        ...
        if (isValid) {
            ...
            findViewById(R.id.btnBaseSend).setVisibility(View.GONE);
            findViewById(R.id.btnLogin).setVisibility(View.GONE);

            findViewById(R.id.llName).setVisibility(View.VISIBLE);
            findViewById(R.id.llSurname).setVisibility(View.VISIBLE);
            findViewById(R.id.llBirthday).setVisibility(View.VISIBLE);
            findViewById(R.id.llCountry).setVisibility(View.VISIBLE);
            findViewById(R.id.llCities).setVisibility(View.VISIBLE);
